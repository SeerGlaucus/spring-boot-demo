...
public class Sql {
	...
	public static int checkPageSize(int pageSize) {
		if (pageSize > com.roncoo.example181.util.base.Page.MAX_PAGE_SIZE) {
			return com.roncoo.example181.util.base.Page.MAX_PAGE_SIZE;
		} else if (pageSize < 1) {
			return com.roncoo.example181.util.base.Page.DEFAULT_PAGE_SIZE;
		} else {
			return pageSize;
		}
	}
