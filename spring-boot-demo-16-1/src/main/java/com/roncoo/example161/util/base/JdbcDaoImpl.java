 ...
 */
package com.roncoo.example161.util.base;
...
public abstract class JdbcDaoImpl {
	...
	public Page<Map<String, Object>> queryForPage(String sql, int pageCurrent, int pageSize, Object... args) {
		...
		String sqlCount = com.roncoo.example161.util.base.Sql.countSql(sql);
		int count = jdbcTemplate.queryForObject(sqlCount, Integer.class, args);
		pageCurrent = com.roncoo.example161.util.base.Sql.checkPageCurrent(count, pageSize, pageCurrent);
		pageSize = com.roncoo.example161.util.base.Sql.checkPageSize(pageSize);
		int totalPage = com.roncoo.example161.util.base.Sql.countTotalPage(count, pageSize);
		String sqlList = sql + com.roncoo.example161.util.base.Sql.limitSql(count, pageCurrent, pageSize);
